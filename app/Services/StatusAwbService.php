...
use App\Repositories\StatusAwbRepository;

class StatusAwbService extends BaseService
{
    protected $repo;

    public function __construct(
        StatusAwbRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'statusawb_name' => 'required|max:255|unique:statusawbs,statusawb_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'statusawb_name' => ['required','max:255',Rule::unique('statusawbs', 'statusawb_name')->ignore($id)]
            ]);

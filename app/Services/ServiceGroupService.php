...
class ServiceGroupService extends BaseService
{
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'servicegroup_name' => 'required|max:255|unique:servicegroups,servicegroup_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'servicegroup_name' => ['required','max:255',Rule::unique('servicegroups', 'servicegroup_name')->ignore($id)]
            ]);

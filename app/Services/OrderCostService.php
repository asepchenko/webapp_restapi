...
class OrderCostService extends BaseService
{
    protected $repo;

    public function __construct(
        OrderCostRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'ordercost_name' => 'required|max:255|unique:ordercosts,ordercost_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'ordercost_name' => ['required','max:255',Rule::unique('ordercosts', 'ordercost_name')->ignore($id)]
            ]);

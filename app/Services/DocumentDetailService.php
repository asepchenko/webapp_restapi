...
class DocumentDetailService extends BaseService
{
    protected $repo;

    public function __construct(
        DocumentDetailRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'documentdetail_name' => 'required|max:255|unique:documentdetails,documentdetail_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'documentdetail_name' => ['required','max:255',Rule::unique('documentdetails', 'documentdetail_name')->ignore($id)]
            ]);

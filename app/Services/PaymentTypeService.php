...
class PaymentTypeService extends BaseService
{
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'paymenttype_name' => 'required|max:255|unique:paymenttypes,paymenttype_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'paymenttype_name' => ['required','max:255',Rule::unique('paymenttypes', 'paymenttype_name')->ignore($id)]
            ]);

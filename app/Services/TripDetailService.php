...
class TripDetailService extends BaseService
{
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'tripdetail_name' => 'required|max:255|unique:tripdetails,tripdetail_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'tripdetail_name' => ['required','max:255',Rule::unique('tripdetails', 'tripdetail_name')->ignore($id)]
            ]);

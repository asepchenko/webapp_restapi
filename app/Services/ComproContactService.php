...
use App\Repositories\ComproContactRepository;

class ComproContactService extends BaseService
{
    protected $repo;

    public function __construct(
        ComproContactRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'comprocontact_name' => 'required|max:255|unique:comprocontacts,comprocontact_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'comprocontact_name' => ['required','max:255',Rule::unique('comprocontacts', 'comprocontact_name')->ignore($id)]
            ]);

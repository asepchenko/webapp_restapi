...
use App\Repositories\ComproPostRepository;

class ComproPostService extends BaseService
{
    protected $repo;

    public function __construct(
        ComproPostRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            $validator = Validator::make($data, [
                'title' => 'required|max:255|unique:compro_posts,title',
                'image' => 'required|file|mimes:jpg,jpeg,png|max:5128'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            $validator = Validator::make($data, [
                'title' => ['required','max:255',Rule::unique('compro_posts', 'title')->ignore($id)],
                'image' => 'file|mimes:mp4,jpg,jpeg,png|max:5128'
            ]);

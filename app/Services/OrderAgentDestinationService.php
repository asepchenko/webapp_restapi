...
class OrderAgentDestinationService extends BaseService
{
    protected $repo;

    public function __construct(
        OrderAgentDestinationRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'orderagentdestination_name' => 'required|max:255|unique:orderagentdestinations,orderagentdestination_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'orderagentdestination_name' => ['required','max:255',Rule::unique('orderagentdestinations', 'orderagentdestination_name')->ignore($id)]
            ]);

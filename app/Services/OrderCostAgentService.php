...
class OrderCostAgentService extends BaseService
{
    protected $repo;

    public function __construct(
        OrderCostAgentRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'ordercostagent_name' => 'required|max:255|unique:ordercostagents,ordercostagent_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'ordercostagent_name' => ['required','max:255',Rule::unique('ordercostagents', 'ordercostagent_name')->ignore($id)]
            ]);

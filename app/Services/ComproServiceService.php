...
use App\Repositories\ComproServiceRepository;

class ComproServiceService extends BaseService
{
    protected $repo;

    public function __construct(
        ComproServiceRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            ...
            if (isset($request->image)) {
                ...
                //delete old file
                Storage::delete('public/services/'.$image);
            }
            ...
            return ResponseFormatter::success($result,'OK Update');
        } catch (Exception $exc) {
            DB::rollBack();
            return ResponseFormatter::error('', $exc->getMessage(),'400');
        }

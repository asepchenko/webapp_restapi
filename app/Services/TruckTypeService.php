...
class TruckTypeService extends BaseService
{
    protected $repo;
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'trucktype_name' => 'required|max:255|unique:trucktypes,trucktype_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'trucktype_name' => ['required','max:255',Rule::unique('trucktypes', 'trucktype_name')->ignore($id)]
            ]);

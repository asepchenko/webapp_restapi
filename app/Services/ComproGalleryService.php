...
use App\Repositories\ComproGalleryRepository;

class ComproGalleryService extends BaseService
{
    protected $repo;

    public function __construct(
        ComproGalleryRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            $request->image->storeAs('public/galleries', $fileName);

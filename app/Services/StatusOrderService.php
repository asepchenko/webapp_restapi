...
class StatusOrderService extends BaseService
{
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'statusorder_name' => 'required|max:255|unique:statusorders,statusorder_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'statusorder_name' => ['required','max:255',Rule::unique('statusorders', 'statusorder_name')->ignore($id)]
            ]);

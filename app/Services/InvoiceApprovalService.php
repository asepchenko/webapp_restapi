...
class InvoiceApprovalService extends BaseService
{
    protected $repo;

    public function __construct(
        InvoiceApprovalRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'invoiceapproval_name' => 'required|max:255|unique:invoiceapprovals,invoiceapproval_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'invoiceapproval_name' => ['required','max:255',Rule::unique('invoiceapprovals', 'invoiceapproval_name')->ignore($id)]
            ]);

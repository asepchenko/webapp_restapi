...
use App\Repositories\ComproMainBannerRepository;

class ComproMainBannerService extends BaseService
{
    protected $repo;

    public function __construct(
        ComproMainBannerRepository $repo
    ) {
        parent::__construct();
        $this->repo = $repo;
    }
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            $request->image->storeAs('public/main-banners', $fileName);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            ...
            if (isset($request->image)) {
                ...
                //delete old file
                Storage::delete('public/main-banners/'.$image);
            }

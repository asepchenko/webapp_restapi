...
class UserAgentService extends BaseService
{
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            //validating
            /*$validator = Validator::make($data, [
                'useragent_name' => 'required|max:255|unique:useragents,useragent_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'useragent_name' => ['required','max:255',Rule::unique('useragents', 'useragent_name')->ignore($id)]
            ]);

...
class NotificationService extends BaseService
{
    ...
    public function indexByLKE(Request $request)
    {
        $data = $this->repo->getIndexByLKE($request);
        if ($data != NULL) {
            return ResponseFormatter::success($data,'OK');
        } else {
    ...
    public function create(Request $request, array $data)
    {
        ...
        try {
            ...
            /*$validator = Validator::make($data, [
                'notification_name' => 'required|max:255|unique:notifications,notification_name'
            ]);
    ...
    public function update(Request $request, array $data, $id)
    {
        ...
        try {
            //validating
            /*$validator = Validator::make($data, [
                'notification_name' => ['required','max:255',Rule::unique('notifications', 'notification_name')->ignore($id)]
            ]);
